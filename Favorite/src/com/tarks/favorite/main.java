...
public class main extends SherlockFragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Generate title
        title = new String[] { user_name ,getString(R.string.favorites), getString(R.string.contacts), getString(R.string.pages), getString(R.string.create_page),  getString(R.string.setting), };
...
//		.setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
    ...
    public void restartApplication() {
        PendingIntent intent = PendingIntent.getActivity(this.getBaseContext(),
                0, new Intent(getIntent()), PendingIntent.FLAG_ONE_SHOT);
